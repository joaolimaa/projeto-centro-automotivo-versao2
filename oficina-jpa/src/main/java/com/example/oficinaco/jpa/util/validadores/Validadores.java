package com.example.oficinaco.jpa.util.validadores;
...
public class Validadores {
    ...
    public static boolean validaTelefone(int ddd, int numero) {
        ...
        if (java.util.Arrays.asList(codigosDDD).indexOf(Integer.parseInt(telefoneTexto.substring(0, 2))) == -1)
            return false;
        ...
        if (telefoneTexto.length() == 10 && java.util.Arrays.asList(prefixos).indexOf(Integer.parseInt(telefoneTexto.substring(2, 3))) == -1)
            return false;
